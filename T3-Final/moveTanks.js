...
export function keyboardUpdate(keyboard, playerTank, scene, projectilesArray, healthPlayer, initialLife) {
    ...
    if (keyboard.down("O")){
        if(playerTank.cameraOn) playerTank.cameraOn = false
        else playerTank.cameraOn = true
    }
